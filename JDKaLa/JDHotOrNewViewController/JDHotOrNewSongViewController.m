//
//  JDHotOrNewSongViewController.m
//  JDKaLa
//
...
@interface JDHotOrNewSongViewController ()

@end

@implementation JDHotOrNewSongViewController
...
- (void)configureView_title:(NSString *)string_title
{
    ...
    UIImageView *image_title = [[UIImageView alloc] initWithFrame:CGRectMake(135, 5, 150, 40)];
    if([string_title isEqualToString:@"新歌速递"])
    {
        [UIUtils didLoadImageNotCached:@"menu_bar_02_new.png" inImageView:image_title];
    }
    else if([string_title isEqualToString:@"最热歌曲"])
    {
        [UIUtils didLoadImageNotCached:@"menu_bar_02_hot.png" inImageView:image_title];
    }
    [view_title addSubview:image_title];
    [image_title release];
