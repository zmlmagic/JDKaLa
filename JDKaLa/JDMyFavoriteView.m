...
@implementation JDMyFavoriteView
...
- (void)configureView_tableView
{
    ...
    self.array_data = [base reciveSongArrayWithTag:1];
    [base release];
...
- (void)installCell:(UITableViewCell *)cell withIndex:(NSInteger)index
{
    ...
    {
        [UIUtils didLoadImageNotCached:@"songs_bar_btn_list.png" inButton:button_favorite withState:UIControlStateNormal];
    }
    else
    {
        [UIUtils didLoadImageNotCached:@"songs_bar_btn_list_added_new.png" inButton:button_favorite withState:UIControlStateNormal];
    }
